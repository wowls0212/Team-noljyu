...
<body>
		...
		<table border="3" width="330px" align="center">
			...
			<tr style="text-align: center;">
				<td colspan="2">
					...
					<input type="button" value="비밀번호 찾기"  onclick="location.href='passwordfind'">
				</td>
			</tr>
		</table>
	</form>
	...
	<div style="text-align: center; margin-top: 30px;">
		<p>
			...
			<!-- 카카오 로그인 -->
			<a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=20a5e796e82f7a14c3129cd0e99636cd&redirect_uri=http://localhost:8080/kakaoLogin&prompt">
				카카오로 로그인 </a>
