...
<tr>
	...
	<td>${re.postnum }</td>
	<td>${re.postreviewnum }</td>
	<td>${re.reviewid }</td>
	<td>${re.reportreason }</td>
	<td>${re.reportid}</td>
	<td>${re.reportdetail}</td>
	<td colspan="2">
	<button type="button" onclick="location.href='reviewreportdel?reportreviewnum=${re.reviewreportnum}&postnum=${re.postnum}&reviewnum=${re.postreviewnum}'">접수</button>
